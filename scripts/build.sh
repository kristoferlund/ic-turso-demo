...
mv $RELEASE_DIR/backend.wasm $RELEASE_DIR/built.wasm

ic-wasm $RELEASE_DIR/built.wasm -o $RELEASE_DIR/meta.wasm metadata candid:service -f ./src/backend/backend.did -v public
